  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-24">
        <div className="text-center mb-16 sm:mb-24">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 px-4">
            <Link href="/register" className="w-full sm:w-auto">
              <Button size="lg" className="font-mono text-sm rounded-sm w-full sm:w-auto">
                Start Monitoring
        ...
        <div className="mt-16 sm:mt-24 p-6 sm:p-8 border border-border/40 rounded-sm">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-[10px] sm:text-xs text-muted-foreground font-mono">Self-Hosted</p>
            </div>
            <div>
